    ...
    >
      <div className="relative h-56 overflow-hidden">
        ...
        <div className="absolute top-4 left-4 flex gap-2">
          ...
          <div className="bg-violet-600 px-3 py-1.5 rounded-full text-white text-[10px] font-bold uppercase tracking-wider shadow-sm">
            {property.type}
          </div>
        </div>
        <div className="absolute bottom-4 right-4">
          ...
          >
            <svg
              ...
              className={
                isSaved ? "text-red-500" : "text-slate-600 hover:text-red-500"
              }
            >
      ...
      <div className="p-5 flex-grow flex flex-col">
        ...
        <h3 className="text-lg font-bold text-slate-900 line-clamp-1 mb-1 group-hover:text-violet-600 transition-colors">
          {property.title}
        </h3>
